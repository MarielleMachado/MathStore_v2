...
import java.security.AuthoritiesConstants;
import java.service.MailService;
import java.service.UserService;
import java.service.dto.AdminUserDTO;
import java.util.ArrayList;
import java.util.Arrays;
import java.util.Collections;
import java.util.List;
import java.web.rest.errors.BadRequestAlertException;
import java.web.rest.errors.EmailAlreadyUsedException;
import java.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link java.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
