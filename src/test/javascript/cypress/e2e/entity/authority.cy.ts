...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '78d8ff0a-733d-4fe1-bc0f-eaa8a49668b1' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c3119a07-31ea-4318-9115-791ee29b81fd');
      cy.get(`[data-cy="name"]`).should('have.value', 'c3119a07-31ea-4318-9115-791ee29b81fd');
