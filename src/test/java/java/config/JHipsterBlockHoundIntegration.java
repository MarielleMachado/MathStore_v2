...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("java.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("java.security.DomainUserDetailsService", "createSpringSecurityUser");
