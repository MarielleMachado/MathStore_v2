...
import java.IntegrationTest;
import java.config.Constants;
import java.domain.User;
import java.repository.AuthorityRepository;
...
import java.service.dto.PasswordChangeDTO;
import java.time.Instant;
import java.util.*;
import java.util.stream.Stream;
import java.web.rest.vm.KeyAndPasswordVM;
import java.web.rest.vm.ManagedUserVM;
